...
### String Filterung
In der Datei `mappings.dart` werden erkannte Wörter und Symbole, welche bedeutungslos sind, mithilfe Regulären Ausdrücken entfernt. Folgender Regex wird verwendet:
