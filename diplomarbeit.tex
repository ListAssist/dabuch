...
\input{tex/converted/camerascanner_coja.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Rafael Doja %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Ziele}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/ziele_doja.tex}

\chapter{Projektplanung}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/projektplanung_doja.tex}

\chapter{Projektumfeldanalyse}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/umfeldanalyse_doja.tex}

\chapter{Risikoanalyse}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/risikoanalyse_doja.tex}

\chapter{Meilensteine}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/meilenstein_doja.tex}

\chapter{Design (DOJ)}
\renewcommand{\kapitelautor}{Autor: Rafael Doja}
\input{tex/converted/design_doja.tex}
